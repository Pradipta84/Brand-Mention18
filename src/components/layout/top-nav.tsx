...
return (
    <header className="relative z-[100] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-3 border-b-2 border-slate-300 bg-white/80 px-2 sm:px-3 md:px-4 lg:px-6 py-2 sm:py-3 md:py-4 backdrop-blur">
      ...
      <div className="relative z-[9999] flex items-center gap-1.5 sm:gap-2 md:gap-4 flex-shrink-0">
        <button
